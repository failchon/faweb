...
var CommunicateComponent = (function () {
    ...
    CommunicateComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: './app/components/pages/home/communicate/communicate.component.html'
        }), 
        __metadata('design:paramtypes', [index_1.HomeService])
    ], CommunicateComponent);
    return CommunicateComponent;
}());
exports.CommunicateComponent = CommunicateComponent;
